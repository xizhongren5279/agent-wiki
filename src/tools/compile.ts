...
import { getWikiDir, getWikiPagesDir, getRawDir, getState, setState } from "../state.js";
import { safeFilename, todayStr, nowStr, parseFrontmatter } from "../utils.js";
...
function updateIndex(
  ...
  // 解析已有索引，按分类收集条目
  const sections: Record<string, Array<{ title: string; tags: string[]; file: string }>> = {};
